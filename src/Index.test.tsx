...
describe('application tests', () => {
  ...
  it('should render name: Adam Alston', () => {
    ...
    checkContent(element, /^Agustin Bouzon$/);
  });

  it('should render title: Software Engineer', () => {
    const element = screen.getByTestId('title');

    checkContent(element, /^Tecnico Programador$/);
  });

  it('should render creator', () => {
    const element = screen.getByTestId('creator');

    checkContent(element, /^Agustin Bouzon$/, 'https://github.com/AgustinBouzonn/');
  });

  it('should render link to source code', () => {
    const element = screen.getByTestId('source');

    checkContent(element, /^Source$/, 'https://github.com/AgustinBouzonn/');
  });
  ...
  it('should render GitHub button', () => {
    ...
    checkButton(parent, child, /^GitHub$/, 'https://github.com/AgustinBouzonn/');
  });
  ...
  it('should render LinkedIn button', () => {
    ...
    checkButton(
      ...
      child,
      /^LinkedIn$/,
      'https://www.linkedin.com/in/agustinbouzon/'
    );
  });
  ...
  it('should render Resume button', () => {
    ...
    checkButton(
      ...
      child,
      /^Resume$/,
      'https://drive.google.com/file/d/1FpOxCUWJ9QmM28iKgGLnkFxIriPMn6qI/'
    );
  });
  ...
  it('should render Email button', () => {
    ...
    checkButton(parent, child, /^Email$/, 'mailto:Agustinbouzon9@gmail.com');
  });
